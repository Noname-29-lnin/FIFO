...
void Vtb_fifo___024root__trace_chg_0_sub_0(Vtb_fifo___024root* vlSelf, VerilatedVcd::Buffer* bufp) {
    ...
    if (VL_UNLIKELY((vlSelf->__Vm_traceActivity[3U] 
        ...
        bufp->chgBit(oldp+15,(vlSelf->tb_fifo__DOT__uut__DOT__update_wr));
        bufp->chgBit(oldp+16,(vlSelf->tb_fifo__DOT__uut__DOT__update_rd));
        bufp->chgCData(oldp+17,(vlSelf->tb_fifo__DOT__uut__DOT__memory_array__DOT__mem[0]),8);
        bufp->chgCData(oldp+18,(vlSelf->tb_fifo__DOT__uut__DOT__memory_array__DOT__mem[1]),8);
        bufp->chgCData(oldp+19,(vlSelf->tb_fifo__DOT__uut__DOT__memory_array__DOT__mem[2]),8);
        bufp->chgCData(oldp+20,(vlSelf->tb_fifo__DOT__uut__DOT__memory_array__DOT__mem[3]),8);
        bufp->chgCData(oldp+21,(vlSelf->tb_fifo__DOT__uut__DOT__memory_array__DOT__mem[4]),8);
        bufp->chgCData(oldp+22,(vlSelf->tb_fifo__DOT__uut__DOT__memory_array__DOT__mem[5]),8);
        bufp->chgCData(oldp+23,(vlSelf->tb_fifo__DOT__uut__DOT__memory_array__DOT__mem[6]),8);
        bufp->chgCData(oldp+24,(vlSelf->tb_fifo__DOT__uut__DOT__memory_array__DOT__mem[7]),8);
    }
    if (VL_UNLIKELY(vlSelf->__Vm_traceActivity[4U])) {
        bufp->chgBit(oldp+25,((1U & ((~ (IData)((0U 
                                     ...
                                     & (((IData)(vlSelf->tb_fifo__DOT__uut__DOT__ptr_rd) 
                                         ^ (IData)(vlSelf->tb_fifo__DOT__uut__DOT__ptr_wr)) 
                                        >> 3U)))));
        bufp->chgBit(oldp+26,(((IData)(vlSelf->tb_fifo__DOT__uut__DOT__ptr_rd) 
                               == (IData)(vlSelf->tb_fifo__DOT__uut__DOT__ptr_wr))));
        bufp->chgCData(oldp+27,(vlSelf->tb_fifo__DOT__uut__DOT__ptr_wr),4);
        bufp->chgCData(oldp+28,(vlSelf->tb_fifo__DOT__uut__DOT__ptr_rd),4);
        bufp->chgCData(oldp+29,((7U & (IData)(vlSelf->tb_fifo__DOT__uut__DOT__ptr_wr))),3);
        bufp->chgCData(oldp+30,((7U & (IData)(vlSelf->tb_fifo__DOT__uut__DOT__ptr_rd))),3);
    }
    bufp->chgBit(oldp+31,(vlSelf->tb_fifo__DOT__i_clk));
    bufp->chgCData(oldp+32,((0xfU & ((IData)(vlSelf->tb_fifo__DOT__uut__DOT__ptr_wr) 
                                     + (IData)(vlSelf->tb_fifo__DOT__uut__DOT__update_wr)))),4);
    bufp->chgCData(oldp+33,((0xfU & ((IData)(vlSelf->tb_fifo__DOT__uut__DOT__ptr_rd) 
