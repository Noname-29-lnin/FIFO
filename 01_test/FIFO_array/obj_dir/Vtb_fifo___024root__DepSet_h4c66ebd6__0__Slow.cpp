...
VL_ATTR_COLD void Vtb_fifo___024root___dump_triggers__act(Vtb_fifo___024root* vlSelf) {
    ...
    if ((4ULL & vlSelf->__VactTriggered.word(0U))) {
        VL_DBG_MSGF("         'act' region trigger index 2 is active: @(posedge tb_fifo.i_clk)\n");
    }
}
#endif  // VL_DEBUG
...
VL_ATTR_COLD void Vtb_fifo___024root___dump_triggers__nba(Vtb_fifo___024root* vlSelf) {
    ...
    if ((4ULL & vlSelf->__VnbaTriggered.word(0U))) {
        VL_DBG_MSGF("         'nba' region trigger index 2 is active: @(posedge tb_fifo.i_clk)\n");
    }
}
#endif  // VL_DEBUG
...
VL_ATTR_COLD void Vtb_fifo___024root___ctor_var_reset(Vtb_fifo___024root* vlSelf) {
    ...
    // Body
    vlSelf->tb_fifo__DOT__i_clk = VL_RAND_RESET_I(1);
    ...
    vlSelf->tb_fifo__DOT__uut__DOT__update_wr = VL_RAND_RESET_I(1);
    vlSelf->tb_fifo__DOT__uut__DOT__update_rd = VL_RAND_RESET_I(1);
    for (int __Vi0 = 0; __Vi0 < 8; ++__Vi0) {
        vlSelf->tb_fifo__DOT__uut__DOT__memory_array__DOT__mem[__Vi0] = VL_RAND_RESET_I(8);
    }
