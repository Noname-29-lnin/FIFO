...
class alignas(VL_CACHE_LINE_BYTES) Vtb_fifo___024root final : public VerilatedModule {
  public:
    ...
    CData/*0:0*/ tb_fifo__DOT__uut__DOT__update_wr;
    CData/*0:0*/ tb_fifo__DOT__uut__DOT__update_rd;
    ...
    VlUnpacked<CData/*7:0*/, 8> tb_fifo__DOT__uut__DOT__memory_array__DOT__mem;
