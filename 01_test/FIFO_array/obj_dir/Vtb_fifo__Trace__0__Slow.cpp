...
VL_ATTR_COLD void Vtb_fifo___024root__trace_init_sub__TOP__0(Vtb_fifo___024root* vlSelf, VerilatedVcd* tracep) {
    ...
    tracep->declBit(c+32,0,"i_clk",-1, VerilatedTraceSigDirection::NONE, VerilatedTraceSigKind::VAR, VerilatedTraceSigType::LOGIC, false,-1);
    ...
    tracep->declBit(c+26,0,"o_full",-1, VerilatedTraceSigDirection::NONE, VerilatedTraceSigKind::VAR, VerilatedTraceSigType::LOGIC, false,-1);
    tracep->declBit(c+27,0,"o_empty",-1, VerilatedTraceSigDirection::NONE, VerilatedTraceSigKind::VAR, VerilatedTraceSigType::LOGIC, false,-1);
    ...
    tracep->declBus(c+35,0,"SIZE_DEPTH",-1, VerilatedTraceSigDirection::NONE, VerilatedTraceSigKind::PARAMETER, VerilatedTraceSigType::LOGIC, false,-1, 31,0);
    tracep->declBit(c+32,0,"i_clk",-1, VerilatedTraceSigDirection::INPUT, VerilatedTraceSigKind::WIRE, VerilatedTraceSigType::LOGIC, false,-1);
    ...
    tracep->declBit(c+26,0,"o_full",-1, VerilatedTraceSigDirection::OUTPUT, VerilatedTraceSigKind::WIRE, VerilatedTraceSigType::LOGIC, false,-1);
    tracep->declBit(c+27,0,"o_empty",-1, VerilatedTraceSigDirection::OUTPUT, VerilatedTraceSigKind::WIRE, VerilatedTraceSigType::LOGIC, false,-1);
    ...
    tracep->declBus(c+28,0,"ptr_wr",-1, VerilatedTraceSigDirection::NONE, VerilatedTraceSigKind::VAR, VerilatedTraceSigType::LOGIC, false,-1, 3,0);
    tracep->declBus(c+29,0,"ptr_rd",-1, VerilatedTraceSigDirection::NONE, VerilatedTraceSigKind::VAR, VerilatedTraceSigType::LOGIC, false,-1, 3,0);
    tracep->declBus(c+33,0,"n_ptr_wr",-1, VerilatedTraceSigDirection::NONE, VerilatedTraceSigKind::WIRE, VerilatedTraceSigType::LOGIC, false,-1, 3,0);
    tracep->declBus(c+34,0,"n_ptr_rd",-1, VerilatedTraceSigDirection::NONE, VerilatedTraceSigKind::WIRE, VerilatedTraceSigType::LOGIC, false,-1, 3,0);
    tracep->declBit(c+16,0,"update_wr",-1, VerilatedTraceSigDirection::NONE, VerilatedTraceSigKind::WIRE, VerilatedTraceSigType::LOGIC, false,-1);
    tracep->declBit(c+17,0,"update_rd",-1, VerilatedTraceSigDirection::NONE, VerilatedTraceSigKind::WIRE, VerilatedTraceSigType::LOGIC, false,-1);
    tracep->pushPrefix("memory_array", VerilatedTracePrefixType::SCOPE_MODULE);
    tracep->declBus(c+35,0,"SIZE_DATA",-1, VerilatedTraceSigDirection::NONE, VerilatedTraceSigKind::PARAMETER, VerilatedTraceSigType::LOGIC, false,-1, 31,0);
    tracep->declBus(c+35,0,"SIZE_DEPTH",-1, VerilatedTraceSigDirection::NONE, VerilatedTraceSigKind::PARAMETER, VerilatedTraceSigType::LOGIC, false,-1, 31,0);
    tracep->declBus(c+36,0,"SIZE_ADDR",-1, VerilatedTraceSigDirection::NONE, VerilatedTraceSigKind::PARAMETER, VerilatedTraceSigType::LOGIC, false,-1, 31,0);
    tracep->declBit(c+16,0,"i_wr_en",-1, VerilatedTraceSigDirection::INPUT, VerilatedTraceSigKind::WIRE, VerilatedTraceSigType::LOGIC, false,-1);
    tracep->declBit(c+17,0,"i_rd_en",-1, VerilatedTraceSigDirection::INPUT, VerilatedTraceSigKind::WIRE, VerilatedTraceSigType::LOGIC, false,-1);
    tracep->declBus(c+30,0,"i_addr_wr",-1, VerilatedTraceSigDirection::INPUT, VerilatedTraceSigKind::WIRE, VerilatedTraceSigType::LOGIC, false,-1, 2,0);
    tracep->declBus(c+31,0,"i_adder_rd",-1, VerilatedTraceSigDirection::INPUT, VerilatedTraceSigKind::WIRE, VerilatedTraceSigType::LOGIC, false,-1, 2,0);
    tracep->declBus(c+4,0,"i_data",-1, VerilatedTraceSigDirection::INPUT, VerilatedTraceSigKind::WIRE, VerilatedTraceSigType::LOGIC, false,-1, 7,0);
    tracep->declBus(c+15,0,"o_data",-1, VerilatedTraceSigDirection::OUTPUT, VerilatedTraceSigKind::WIRE, VerilatedTraceSigType::LOGIC, false,-1, 7,0);
...
VL_ATTR_COLD void Vtb_fifo___024root__trace_full_0_sub_0(Vtb_fifo___024root* vlSelf, VerilatedVcd::Buffer* bufp) {
    ...
    bufp->fullBit(oldp+16,(vlSelf->tb_fifo__DOT__uut__DOT__update_wr));
    bufp->fullBit(oldp+17,(vlSelf->tb_fifo__DOT__uut__DOT__update_rd));
    bufp->fullCData(oldp+18,(vlSelf->tb_fifo__DOT__uut__DOT__memory_array__DOT__mem[0]),8);
    bufp->fullCData(oldp+19,(vlSelf->tb_fifo__DOT__uut__DOT__memory_array__DOT__mem[1]),8);
    bufp->fullCData(oldp+20,(vlSelf->tb_fifo__DOT__uut__DOT__memory_array__DOT__mem[2]),8);
    bufp->fullCData(oldp+21,(vlSelf->tb_fifo__DOT__uut__DOT__memory_array__DOT__mem[3]),8);
    bufp->fullCData(oldp+22,(vlSelf->tb_fifo__DOT__uut__DOT__memory_array__DOT__mem[4]),8);
    bufp->fullCData(oldp+23,(vlSelf->tb_fifo__DOT__uut__DOT__memory_array__DOT__mem[5]),8);
    bufp->fullCData(oldp+24,(vlSelf->tb_fifo__DOT__uut__DOT__memory_array__DOT__mem[6]),8);
    bufp->fullCData(oldp+25,(vlSelf->tb_fifo__DOT__uut__DOT__memory_array__DOT__mem[7]),8);
    bufp->fullBit(oldp+26,((1U & ((~ (IData)((0U != 
                                  ...
                                  & (((IData)(vlSelf->tb_fifo__DOT__uut__DOT__ptr_rd) 
                                      ^ (IData)(vlSelf->tb_fifo__DOT__uut__DOT__ptr_wr)) 
                                     >> 3U)))));
    bufp->fullBit(oldp+27,(((IData)(vlSelf->tb_fifo__DOT__uut__DOT__ptr_rd) 
                            == (IData)(vlSelf->tb_fifo__DOT__uut__DOT__ptr_wr))));
    bufp->fullCData(oldp+28,(vlSelf->tb_fifo__DOT__uut__DOT__ptr_wr),4);
    bufp->fullCData(oldp+29,(vlSelf->tb_fifo__DOT__uut__DOT__ptr_rd),4);
    bufp->fullCData(oldp+30,((7U & (IData)(vlSelf->tb_fifo__DOT__uut__DOT__ptr_wr))),3);
    bufp->fullCData(oldp+31,((7U & (IData)(vlSelf->tb_fifo__DOT__uut__DOT__ptr_rd))),3);
    bufp->fullBit(oldp+32,(vlSelf->tb_fifo__DOT__i_clk));
    bufp->fullCData(oldp+33,((0xfU & ((IData)(vlSelf->tb_fifo__DOT__uut__DOT__ptr_wr) 
                                      + (IData)(vlSelf->tb_fifo__DOT__uut__DOT__update_wr)))),4);
    bufp->fullCData(oldp+34,((0xfU & ((IData)(vlSelf->tb_fifo__DOT__uut__DOT__ptr_rd) 
                                      + (IData)(vlSelf->tb_fifo__DOT__uut__DOT__update_rd)))),4);
}
