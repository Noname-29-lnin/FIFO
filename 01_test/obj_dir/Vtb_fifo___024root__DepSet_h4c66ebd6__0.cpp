...
VL_INLINE_OPT VlCoroutine Vtb_fifo___024root___eval_initial__TOP__Vtiming__0(Vtb_fifo___024root* vlSelf) {
              ...
              1,(((0xfU & (IData)(vlSelf->tb_fifo__DOT__uut__DOT__ptr_rd)) 
                 ...
                 & ((1U & ((IData)(vlSelf->tb_fifo__DOT__uut__DOT__ptr_rd) 
                           >> 4U)) != (1U & ((IData)(vlSelf->tb_fifo__DOT__uut__DOT__ptr_wr) 
                                             >> 4U)))),
              8,(IData)(vlSelf->tb_fifo__DOT__o_data),
    ...
    VL_WRITEF("Time = %t, o_full = %b, ptr_wr = %2#, ptr_rd = %2#\n",
              64,VL_TIME_UNITED_Q(1),-12,1,(((0xfU 
    ...
    VL_WRITEF("Test case 2: Write data until full\n=> TestCase2: %s\n-------------- Test Case 3 --------------\n",
              32,((((0xfU & (IData)(vlSelf->tb_fifo__DOT__uut__DOT__ptr_rd)) 
                    == (0xfU & (IData)(vlSelf->tb_fifo__DOT__uut__DOT__ptr_wr))) 
                   & ((1U & ((IData)(vlSelf->tb_fifo__DOT__uut__DOT__ptr_rd) 
                             >> 4U)) != (1U & ((IData)(vlSelf->tb_fifo__DOT__uut__DOT__ptr_wr) 
                                               >> 4U))))
...
VL_INLINE_OPT void Vtb_fifo___024root___nba_sequent__TOP__0(Vtb_fifo___024root* vlSelf) {
    ...
    CData/*0:0*/ __Vdlyvset__tb_fifo__DOT__uut__DOT__RAM__DOT__mem__v0;
    __Vdlyvset__tb_fifo__DOT__uut__DOT__RAM__DOT__mem__v0 = 0;
    // Body
    __Vdlyvset__tb_fifo__DOT__uut__DOT__RAM__DOT__mem__v0 = 0U;
    if (vlSelf->tb_fifo__DOT__i_wr_en) {
        __Vdlyvval__tb_fifo__DOT__uut__DOT__RAM__DOT__mem__v0 
