...
VL_INLINE_OPT VlCoroutine Vtb_fifo___024root___eval_initial__TOP__Vtiming__0(Vtb_fifo___024root* vlSelf) {
    ...
    vlSelf->tb_fifo__DOT__i_data = 0U;
    ...
    VL_WRITEF("Test case 2: Write data until full\n=> TestCase2: %s\n-------------- Test Case 3 --------------\n",
              32,((IData)(vlSelf->tb_fifo__DOT__o_full)
    ...
    VL_WRITEF("Test case 3: Read data until empty\n=> TestCase3: %s\n-------------- Test Case 4 --------------\n",
              32,((IData)(vlSelf->tb_fifo__DOT__o_empty)
                   ? 0x50415353U : 0x4641494cU));
...
VL_INLINE_OPT void Vtb_fifo___024root___act_sequent__TOP__0(Vtb_fifo___024root* vlSelf) {
    if (false && vlSelf) {}  // Prevent unused
    Vtb_fifo__Syms* const __restrict vlSymsp VL_ATTR_UNUSED = vlSelf->vlSymsp;
    VL_DEBUG_IF(VL_DBG_MSGF("+    Vtb_fifo___024root___act_sequent__TOP__0\n"); );
    // Body
...
void Vtb_fifo___024root___eval_act(Vtb_fifo___024root* vlSelf) {
    ...
    if ((1ULL & vlSelf->__VactTriggered.word(0U))) {
        Vtb_fifo___024root___act_sequent__TOP__0(vlSelf);
    }
...
VL_INLINE_OPT void Vtb_fifo___024root___nba_sequent__TOP__0(Vtb_fifo___024root* vlSelf) {
    ...
    // Init
    CData/*1:0*/ __Vdlyvdim0__tb_fifo__DOT__uut__DOT__lut_mem__DOT__mem__v0;
    __Vdlyvdim0__tb_fifo__DOT__uut__DOT__lut_mem__DOT__mem__v0 = 0;
    CData/*7:0*/ __Vdlyvval__tb_fifo__DOT__uut__DOT__lut_mem__DOT__mem__v0;
    __Vdlyvval__tb_fifo__DOT__uut__DOT__lut_mem__DOT__mem__v0 = 0;
    CData/*0:0*/ __Vdlyvset__tb_fifo__DOT__uut__DOT__lut_mem__DOT__mem__v0;
    __Vdlyvset__tb_fifo__DOT__uut__DOT__lut_mem__DOT__mem__v0 = 0;
    CData/*0:0*/ __Vdlyvset__tb_fifo__DOT__uut__DOT__lut_mem__DOT__mem__v1;
    __Vdlyvset__tb_fifo__DOT__uut__DOT__lut_mem__DOT__mem__v1 = 0;
    // Body
    __Vdlyvset__tb_fifo__DOT__uut__DOT__lut_mem__DOT__mem__v0 = 0U;
    __Vdlyvset__tb_fifo__DOT__uut__DOT__lut_mem__DOT__mem__v1 = 0U;
    if (vlSelf->tb_fifo__DOT__i_rst_n) {
        if (vlSelf->tb_fifo__DOT__i_wr_en) {
            vlSelf->tb_fifo__DOT__uut__DOT__lut_mem__DOT____Vlvbound_h2ccb6805__0 
                = vlSelf->tb_fifo__DOT__i_data;
            if ((2U >= (3U & (IData)(vlSelf->tb_fifo__DOT__uut__DOT__ptr_wr)))) {
                __Vdlyvval__tb_fifo__DOT__uut__DOT__lut_mem__DOT__mem__v0 
                    = vlSelf->tb_fifo__DOT__uut__DOT__lut_mem__DOT____Vlvbound_h2ccb6805__0;
                __Vdlyvset__tb_fifo__DOT__uut__DOT__lut_mem__DOT__mem__v0 = 1U;
                __Vdlyvdim0__tb_fifo__DOT__uut__DOT__lut_mem__DOT__mem__v0 
                    = (3U & (IData)(vlSelf->tb_fifo__DOT__uut__DOT__ptr_wr));
            }
        }
        if ((1U & (~ (IData)(vlSelf->tb_fifo__DOT__i_wr_en)))) {
            if (vlSelf->tb_fifo__DOT__i_rd_en) {
                vlSelf->tb_fifo__DOT__o_data = ((2U 
                                                 >= 
                                                 (3U 
                                                  & (IData)(vlSelf->tb_fifo__DOT__uut__DOT__ptr_rd)))
                                                 ? 
                                                vlSelf->tb_fifo__DOT__uut__DOT__lut_mem__DOT__mem
                                                [(3U 
                                                  & (IData)(vlSelf->tb_fifo__DOT__uut__DOT__ptr_rd))]
                                                 : 0U);
            }
        ...
        __Vdlyvset__tb_fifo__DOT__uut__DOT__lut_mem__DOT__mem__v1 = 1U;
        vlSelf->tb_fifo__DOT__o_data = 0U;
        vlSelf->tb_fifo__DOT__uut__DOT__ptr_wr = 0U;
        vlSelf->tb_fifo__DOT__uut__DOT__ptr_rd = 0U;
    }
    if (__Vdlyvset__tb_fifo__DOT__uut__DOT__lut_mem__DOT__mem__v0) {
        vlSelf->tb_fifo__DOT__uut__DOT__lut_mem__DOT__mem[__Vdlyvdim0__tb_fifo__DOT__uut__DOT__lut_mem__DOT__mem__v0] 
            = __Vdlyvval__tb_fifo__DOT__uut__DOT__lut_mem__DOT__mem__v0;
    }
    if (__Vdlyvset__tb_fifo__DOT__uut__DOT__lut_mem__DOT__mem__v1) {
        vlSelf->tb_fifo__DOT__uut__DOT__lut_mem__DOT__mem[0U] = 0U;
    }
