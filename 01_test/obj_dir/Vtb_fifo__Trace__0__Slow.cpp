...
VL_ATTR_COLD void Vtb_fifo___024root__trace_init_sub__TOP__0(Vtb_fifo___024root* vlSelf, VerilatedVcd* tracep) {
    ...
    tracep->declBus(c+26,0,"SIZE_DEPTH",-1, VerilatedTraceSigDirection::NONE, VerilatedTraceSigKind::PARAMETER, VerilatedTraceSigType::LOGIC, false,-1, 31,0);
    ...
    tracep->declBit(c+23,0,"o_full",-1, VerilatedTraceSigDirection::NONE, VerilatedTraceSigKind::VAR, VerilatedTraceSigType::LOGIC, false,-1);
    tracep->declBit(c+16,0,"o_empty",-1, VerilatedTraceSigDirection::NONE, VerilatedTraceSigKind::VAR, VerilatedTraceSigType::LOGIC, false,-1);
    tracep->declBus(c+28,0,"pt_wr",-1, VerilatedTraceSigDirection::NONE, VerilatedTraceSigKind::VAR, VerilatedTraceSigType::LOGIC, false,-1, 2,0);
    tracep->declBus(c+29,0,"pt_rd",-1, VerilatedTraceSigDirection::NONE, VerilatedTraceSigKind::VAR, VerilatedTraceSigType::LOGIC, false,-1, 2,0);
    ...
    tracep->declBus(c+38,0,"match_count",-1, VerilatedTraceSigDirection::NONE, VerilatedTraceSigKind::VAR, VerilatedTraceSigType::INTEGER, false,-1, 31,0);
    ...
    tracep->declBit(c+23,0,"o_full",-1, VerilatedTraceSigDirection::OUTPUT, VerilatedTraceSigKind::WIRE, VerilatedTraceSigType::LOGIC, false,-1);
    tracep->declBit(c+16,0,"o_empty",-1, VerilatedTraceSigDirection::OUTPUT, VerilatedTraceSigKind::WIRE, VerilatedTraceSigType::LOGIC, false,-1);
    tracep->declBus(c+27,0,"ADDR",-1, VerilatedTraceSigDirection::NONE, VerilatedTraceSigKind::PARAMETER, VerilatedTraceSigType::LOGIC, false,-1, 31,0);
    tracep->declBus(c+17,0,"ptr_rd",-1, VerilatedTraceSigDirection::NONE, VerilatedTraceSigKind::VAR, VerilatedTraceSigType::LOGIC, false,-1, 2,0);
    tracep->declBus(c+18,0,"ptr_wr",-1, VerilatedTraceSigDirection::NONE, VerilatedTraceSigKind::VAR, VerilatedTraceSigType::LOGIC, false,-1, 2,0);
    tracep->declBus(c+24,0,"n_ptr_rd",-1, VerilatedTraceSigDirection::NONE, VerilatedTraceSigKind::VAR, VerilatedTraceSigType::LOGIC, false,-1, 2,0);
    tracep->declBus(c+25,0,"n_ptr_wr",-1, VerilatedTraceSigDirection::NONE, VerilatedTraceSigKind::VAR, VerilatedTraceSigType::LOGIC, false,-1, 2,0);
    tracep->pushPrefix("lut_mem", VerilatedTracePrefixType::SCOPE_MODULE);
    tracep->declBus(c+26,0,"SIZE_DATA",-1, VerilatedTraceSigDirection::NONE, VerilatedTraceSigKind::PARAMETER, VerilatedTraceSigType::LOGIC, false,-1, 31,0);
    tracep->declBus(c+27,0,"SIZE_ADDR",-1, VerilatedTraceSigDirection::NONE, VerilatedTraceSigKind::PARAMETER, VerilatedTraceSigType::LOGIC, false,-1, 31,0);
    tracep->declBit(c+22,0,"i_clk",-1, VerilatedTraceSigDirection::INPUT, VerilatedTraceSigKind::WIRE, VerilatedTraceSigType::LOGIC, false,-1);
    tracep->declBit(c+1,0,"i_rst_n",-1, VerilatedTraceSigDirection::INPUT, VerilatedTraceSigKind::WIRE, VerilatedTraceSigType::LOGIC, false,-1);
    tracep->declBit(c+2,0,"i_wr_en",-1, VerilatedTraceSigDirection::INPUT, VerilatedTraceSigKind::WIRE, VerilatedTraceSigType::LOGIC, false,-1);
    tracep->declBit(c+3,0,"i_rd_en",-1, VerilatedTraceSigDirection::INPUT, VerilatedTraceSigKind::WIRE, VerilatedTraceSigType::LOGIC, false,-1);
    tracep->declBus(c+18,0,"i_wr_addr",-1, VerilatedTraceSigDirection::INPUT, VerilatedTraceSigKind::WIRE, VerilatedTraceSigType::LOGIC, false,-1, 2,0);
    tracep->declBus(c+17,0,"i_rd_addr",-1, VerilatedTraceSigDirection::INPUT, VerilatedTraceSigKind::WIRE, VerilatedTraceSigType::LOGIC, false,-1, 2,0);
    tracep->declBus(c+4,0,"i_data",-1, VerilatedTraceSigDirection::INPUT, VerilatedTraceSigKind::WIRE, VerilatedTraceSigType::LOGIC, false,-1, 7,0);
    tracep->declBus(c+15,0,"o_data",-1, VerilatedTraceSigDirection::OUTPUT, VerilatedTraceSigKind::WIRE, VerilatedTraceSigType::LOGIC, false,-1, 7,0);
...
VL_ATTR_COLD void Vtb_fifo___024root__trace_const_0_sub_0(Vtb_fifo___024root* vlSelf, VerilatedVcd::Buffer* bufp) {
    ...
    bufp->fullCData(oldp+28,(vlSelf->tb_fifo__DOT__pt_wr),3);
    bufp->fullCData(oldp+29,(vlSelf->tb_fifo__DOT__pt_rd),3);
    bufp->fullCData(oldp+30,(vlSelf->tb_fifo__DOT__value_wr[0]),8);
    bufp->fullCData(oldp+31,(vlSelf->tb_fifo__DOT__value_wr[1]),8);
    bufp->fullCData(oldp+32,(vlSelf->tb_fifo__DOT__value_wr[2]),8);
    bufp->fullCData(oldp+33,(vlSelf->tb_fifo__DOT__value_wr[3]),8);
    bufp->fullCData(oldp+34,(vlSelf->tb_fifo__DOT__value_wr[4]),8);
    bufp->fullCData(oldp+35,(vlSelf->tb_fifo__DOT__value_wr[5]),8);
    bufp->fullCData(oldp+36,(vlSelf->tb_fifo__DOT__value_wr[6]),8);
    bufp->fullCData(oldp+37,(vlSelf->tb_fifo__DOT__value_wr[7]),8);
    bufp->fullIData(oldp+38,(vlSelf->tb_fifo__DOT__match_count),32);
}
...
VL_ATTR_COLD void Vtb_fifo___024root__trace_full_0_sub_0(Vtb_fifo___024root* vlSelf, VerilatedVcd::Buffer* bufp) {
    ...
    bufp->fullBit(oldp+16,(vlSelf->tb_fifo__DOT__o_empty));
    bufp->fullCData(oldp+17,(vlSelf->tb_fifo__DOT__uut__DOT__ptr_rd),3);
    bufp->fullCData(oldp+18,(vlSelf->tb_fifo__DOT__uut__DOT__ptr_wr),3);
    bufp->fullCData(oldp+19,(vlSelf->tb_fifo__DOT__uut__DOT__lut_mem__DOT__mem[0]),8);
    bufp->fullCData(oldp+20,(vlSelf->tb_fifo__DOT__uut__DOT__lut_mem__DOT__mem[1]),8);
    bufp->fullCData(oldp+21,(vlSelf->tb_fifo__DOT__uut__DOT__lut_mem__DOT__mem[2]),8);
    bufp->fullBit(oldp+22,(vlSelf->tb_fifo__DOT__i_clk));
    bufp->fullBit(oldp+23,(vlSelf->tb_fifo__DOT__o_full));
    bufp->fullCData(oldp+24,(vlSelf->tb_fifo__DOT__uut__DOT__n_ptr_rd),3);
    bufp->fullCData(oldp+25,(vlSelf->tb_fifo__DOT__uut__DOT__n_ptr_wr),3);
}
